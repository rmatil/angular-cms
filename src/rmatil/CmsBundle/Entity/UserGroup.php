...
class UserGroup {
     ...
     * @see \rmatil\CmsBundle\Entity\Article::$allowedUserGroups
     ...
     * @MaxDepth(2)
     *
     * @var ArrayCollection[rmatil\CmsBundle\Entity\Article]
     */
     ...
     *
     * THIS IS THE OWNING SIDE.
     * @see \rmatil\CmsBundle\Entity\Page::$allowedUserGroups
     * @link http://docs.doctrine-project.org/en/latest/reference/working-with-associations.html#working-with-associations
     *
     * @ORM\ManyToMany(targetEntity="Page", inversedBy="allowedUserGroups")
     *
     * @Type("ArrayCollection<rmatil\CmsBundle\Entity\Page>")
     * @MaxDepth(2)
     *
     * @var ArrayCollection[rmatil\CmsBundle\Entity\Page]
     */
     ...
     *
     * THIS IS THE OWNING SIDE.
     * @see \rmatil\CmsBundle\Entity\Event::$allowedUserGroups
     * @link http://docs.doctrine-project.org/en/latest/reference/working-with-associations.html#working-with-associations
     *
     * @ORM\ManyToMany(targetEntity="Event", inversedBy="allowedUserGroups")
     *
     * @Type("ArrayCollection<rmatil\CmsBundle\Entity\Event>")
     * @MaxDepth(2)
     *
     * @var ArrayCollection[rmatil\CmsBundle\Entity\Event]
     */
     ...
     * user group
     *
     * @return ArrayCollection[rmatil\CmsBundle\Entity\Article]
     */
     ...
     *
     * @param ArrayCollection [rmatil\CmsBundle\Entity\Article] $accessibleArticles
     */
