 ...
 */
class Version20160730142019 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_1483A5E927166DDE ON users');
        $this->addSql('ALTER TABLE users ADD enabled TINYINT(1) NOT NULL, ADD salt VARCHAR(255) NOT NULL, ADD password VARCHAR(255) NOT NULL, ADD last_login DATETIME DEFAULT NULL, ADD locked TINYINT(1) NOT NULL, ADD expired TINYINT(1) NOT NULL, ADD expires_at DATETIME DEFAULT NULL, ADD confirmation_token VARCHAR(255) DEFAULT NULL, ADD password_requested_at DATETIME DEFAULT NULL, ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', ADD credentials_expired TINYINT(1) NOT NULL, ADD credentials_expire_at DATETIME DEFAULT NULL, ADD username_canonical VARCHAR(191) NOT NULL, ADD email_canonical VARCHAR(191) NOT NULL, DROP user_group_id, DROP is_locked_by_id, DROP plain_password, DROP password_hash, DROP last_login_date, DROP registration_date, DROP is_locked, DROP has_email_validated, CHANGE user_name username VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE users ADD user_group_id INT DEFAULT NULL, ADD is_locked_by_id INT DEFAULT NULL, ADD user_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD password_hash VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, ADD last_login_date DATETIME NOT NULL, ADD registration_date DATETIME NOT NULL, ADD is_locked TINYINT(1) NOT NULL, ADD has_email_validated TINYINT(1) NOT NULL, DROP username, DROP enabled, DROP salt, DROP password, DROP last_login, DROP locked, DROP expired, DROP expires_at, DROP password_requested_at, DROP roles, DROP credentials_expired, DROP credentials_expire_at, DROP username_canonical, DROP email_canonical, CHANGE confirmation_token plain_password VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('CREATE INDEX IDX_1483A5E927166DDE ON users (is_locked_by_id)');
    }
}
