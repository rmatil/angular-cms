 ...
 */
class Version20160601144812 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, author_id INT DEFAULT NULL, language_id INT DEFAULT NULL, page_id INT DEFAULT NULL, url_name VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT DEFAULT NULL, last_edit_date DATETIME NOT NULL, creation_date DATETIME NOT NULL, is_published TINYINT(1) NOT NULL, INDEX IDX_BFDD316812469DE2 (category_id), INDEX IDX_BFDD3168F675F31B (author_id), INDEX IDX_BFDD316882F1BAF4 (language_id), INDEX IDX_BFDD3168C4663E4 (page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE articleCategories (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE events (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, location_id INT DEFAULT NULL, file_id INT DEFAULT NULL, repeat_option_id INT DEFAULT NULL, is_locked_by_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, start_date DATETIME DEFAULT NULL, end_date DATETIME DEFAULT NULL, description LONGTEXT DEFAULT NULL, last_edit_date DATETIME NOT NULL, creation_date DATETIME NOT NULL, url_name VARCHAR(255) NOT NULL, INDEX IDX_5387574AF675F31B (author_id), INDEX IDX_5387574A64D218E (location_id), INDEX IDX_5387574A93CB796C (file_id), INDEX IDX_5387574AC8A9295D (repeat_option_id), INDEX IDX_5387574A27166DDE (is_locked_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE files (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, author_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, local_path VARCHAR(255) NOT NULL, thumbnail_link VARCHAR(255) DEFAULT NULL, local_thumbnail_path VARCHAR(255) DEFAULT NULL, extension VARCHAR(255) NOT NULL, size INT NOT NULL, dimensions VARCHAR(255) NOT NULL, creation_date DATETIME NOT NULL, INDEX IDX_635405912469DE2 (category_id), INDEX IDX_6354059F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fileCategories (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pages (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, author_id INT DEFAULT NULL, language_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, is_locked_by_id INT DEFAULT NULL, url_name VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, has_subnavigation TINYINT(1) NOT NULL, is_published TINYINT(1) NOT NULL, last_edit_date DATETIME NOT NULL, creation_date DATETIME NOT NULL, is_start_page TINYINT(1) NOT NULL, INDEX IDX_2074E57512469DE2 (category_id), INDEX IDX_2074E575F675F31B (author_id), INDEX IDX_2074E57582F1BAF4 (language_id), INDEX IDX_2074E575727ACA70 (parent_id), INDEX IDX_2074E57527166DDE (is_locked_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pageCategories (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE registrations (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, expiration_date DATETIME NOT NULL, token VARCHAR(255) NOT NULL, INDEX IDX_53DE51E7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE repeatOptions (id INT AUTO_INCREMENT NOT NULL, option_value VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, user_group_id INT DEFAULT NULL, is_locked_by_id INT DEFAULT NULL, user_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone_number VARCHAR(255) DEFAULT NULL, mobile_number VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(255) DEFAULT NULL, place VARCHAR(255) DEFAULT NULL, plain_password VARCHAR(255) DEFAULT NULL, password_hash VARCHAR(255) DEFAULT NULL, last_login_date DATETIME NOT NULL, registration_date DATETIME NOT NULL, is_locked TINYINT(1) NOT NULL, has_email_validated TINYINT(1) NOT NULL, INDEX IDX_1483A5E91ED93D47 (user_group_id), INDEX IDX_1483A5E927166DDE (is_locked_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE userGroups (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_group_article (user_group_id INT NOT NULL, article_id INT NOT NULL, INDEX IDX_6AB4F73A1ED93D47 (user_group_id), INDEX IDX_6AB4F73A7294869C (article_id), PRIMARY KEY(user_group_id, article_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_group_page (user_group_id INT NOT NULL, page_id INT NOT NULL, INDEX IDX_9A372BBC1ED93D47 (user_group_id), INDEX IDX_9A372BBCC4663E4 (page_id), PRIMARY KEY(user_group_id, page_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_group_event (user_group_id INT NOT NULL, event_id INT NOT NULL, INDEX IDX_C299E8551ED93D47 (user_group_id), INDEX IDX_C299E85571F7E88B (event_id), PRIMARY KEY(user_group_id, event_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E91ED93D47 FOREIGN KEY (user_group_id) REFERENCES userGroups (id)');
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E927166DDE FOREIGN KEY (is_locked_by_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_group_article DROP FOREIGN KEY FK_6AB4F73A7294869C');
        $this->addSql('ALTER TABLE articles DROP FOREIGN KEY FK_BFDD316812469DE2');
        $this->addSql('ALTER TABLE user_group_event DROP FOREIGN KEY FK_C299E85571F7E88B');
        ...
        $this->addSql('ALTER TABLE user_group_page DROP FOREIGN KEY FK_9A372BBCC4663E4');
        ...
        $this->addSql('ALTER TABLE users DROP FOREIGN KEY FK_1483A5E927166DDE');
        $this->addSql('ALTER TABLE users DROP FOREIGN KEY FK_1483A5E91ED93D47');
        $this->addSql('ALTER TABLE user_group_article DROP FOREIGN KEY FK_6AB4F73A1ED93D47');
        $this->addSql('ALTER TABLE user_group_page DROP FOREIGN KEY FK_9A372BBC1ED93D47');
        $this->addSql('ALTER TABLE user_group_event DROP FOREIGN KEY FK_C299E8551ED93D47');
