...
angular.module('cms.controllers')
    ...
    .controller('locationAddCtrl', ['genService', 'MenuService', '$scope', '$location', '$timeout', '$log', '$q', 'toaster', function (genService, MenuService, $scope, $location, $timeout, $log, $q, toaster) {
        // set Menu according to its Name
        MenuService.update("Veranstaltungen");
        ...
        $scope.saveLocation = function (pLocation) {
            ...
            $scope.loading = true;
            genService.insertObject('locations', pLocation).then(function () {
